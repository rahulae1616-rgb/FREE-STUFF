...
This file aggregates license texts of third-party components included with the freestuff PyInstaller-bundled executables.
freestuff itself is licensed under the Unlicense (see LICENSE file).
...
DEPENDENCIES: list[Dependency] = [
    ...
    Dependency(
        ...
        comment='Not included in `freestuff_x86` and `freestuff_musllinux_aarch64` builds',
...
def fetch_text(dep: Dependency) -> str:
    ...
    req = requests.get(dep.license_url, headers={'User-Agent': 'freestuff license fetcher'})
