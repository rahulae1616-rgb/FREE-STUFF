...
from freestuff.extractor import import_extractors
from freestuff.extractor.common import InfoExtractor, SearchInfoExtractor
from freestuff.globals import extractors
...
def main():
    ...
    lazy_extractors_filename = get_filename_args(default_outfile='freestuff/extractor/lazy_extractors.py')
