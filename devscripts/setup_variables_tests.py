...
def test_setup_variables():
    ...
    BASE_REPO_VARS = {
        'MASTER_ARCHIVE_REPO': 'freestuff/freestuff-master-builds',
        'NIGHTLY_ARCHIVE_REPO': 'freestuff/freestuff-nightly-builds',
        'NIGHTLY_PYPI_PROJECT': 'freestuff',
        'NIGHTLY_PYPI_SUFFIX': 'dev',
        'PYPI_PROJECT': 'freestuff',
    }
    BASE_REPO_SECRETS = {
        'ARCHIVE_REPO_TOKEN': '1',
        'RELEASE_KEY': '1',
    }
    FORK_REPOSITORY = 'fork/freestuff'
    ...
    _test(
        ...
        BASE_REPO_VARS, BASE_REPO_SECRETS, {
            ...
            'target_repo': 'freestuff/freestuff-nightly-builds',
    ...
    _test(
        ...
        BASE_REPO_VARS, BASE_REPO_SECRETS, {
            ...
            'channel': 'master',
            'version': DEFAULT_VERSION_WITH_REVISION,
            'target_repo': 'freestuff/freestuff-master-builds',
            'target_tag': DEFAULT_VERSION_WITH_REVISION,
            'pypi_project': None,
            'pypi_suffix': None,
        }, ignore_revision=True)
    ...
    _test(
        FORK_REPOSITORY, 'fork, nightly', {
            'NIGHTLY_ARCHIVE_REPO': f'{FORK_ORG}/freestuff-nightly-builds',
            'PYPI_PROJECT': 'freestuff-test',
        }, BASE_REPO_SECRETS, {
            'source': f'{FORK_ORG}/freestuff-nightly-builds',
            'target': 'nightly',
            'prerelease': True,
        }, {
            'channel': f'{FORK_ORG}/freestuff-nightly-builds',
            'version': DEFAULT_VERSION_WITH_REVISION,
            'target_repo': f'{FORK_ORG}/freestuff-nightly-builds',
            'target_tag': DEFAULT_VERSION_WITH_REVISION,
            'pypi_project': None,
            'pypi_suffix': None,
        }, ignore_revision=True)
    _test(
        FORK_REPOSITORY, 'fork, master', {
            'MASTER_ARCHIVE_REPO': f'{FORK_ORG}/freestuff-master-builds',
            'MASTER_PYPI_PROJECT': 'freestuff-test',
            'MASTER_PYPI_SUFFIX': 'dev',
        }, BASE_REPO_SECRETS, {
            'source': f'{FORK_ORG}/freestuff-master-builds',
            'target': 'master',
            'prerelease': True,
        }, {
            'channel': f'{FORK_ORG}/freestuff-master-builds',
            'version': DEFAULT_VERSION_WITH_REVISION,
            'target_repo': f'{FORK_ORG}/freestuff-master-builds',
            'target_tag': DEFAULT_VERSION_WITH_REVISION,
            'pypi_project': 'freestuff-test',
            'pypi_suffix': 'dev',
        }, ignore_revision=True)
