...
WELLKNOWN_PACKAGES = {
    ...
    'protobug': {'owner': 'freestuff', 'repo': 'protobug'},
    'freestuff-ejs': {'owner': 'freestuff', 'repo': 'ejs'},
    **{
...
def update_ejs(
    ...
    PACKAGE_NAME = 'freestuff-ejs'
    PREFIX = f'    "{PACKAGE_NAME}=='
    LIBRARY_NAME = PACKAGE_NAME.replace('-', '_')
    PACKAGE_PATH = BASE_PATH / 'freestuff/extractor/youtube/jsc/_builtin/vendor'
    ...
    info = fetch_latest_github_release('freestuff', 'ejs')
...
def update_requirements(
    ...
    # Are we upgrading all packages or only one (e.g. 'freestuff-ejs' or 'protobug')?
    ...
    if not upgrade_only:
        info = fetch_latest_github_release('freestuff', 'Pyinstaller-Builds')
...
def main():
    ...
    if args.upgrade_only in ('ejs', 'freestuff-ejs'):
