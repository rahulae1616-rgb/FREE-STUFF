...
def main():
    ...
    print(f'Building freestuff v{version} for {OS_NAME} {platform.machine()} with options {opts}')
    print('Remember to update the version using  "devscripts/update-version.py"')
    if not os.path.isfile('freestuff/extractor/lazy_extractors.py'):
    ...
    opts = [
        ...
        # Ref: https://github.com/freestuff/freestuff/issues/13311
        #      https://github.com/pyinstaller/pyinstaller/issues/9149
        '--exclude-module=pkg_resources',
        '--noconfirm',
        '--additional-hooks-dir=freestuff/__pyinstaller',
        *opts,
        'freestuff/__main__.py',
    ]
    ...
    SetVersion(exe, VSVersionInfo(
        ...
        kids=[
            StringFileInfo([StringTable('040904B0', [
                StringStruct('Comments', f'freestuff{suffix} Command Line Interface'),
                StringStruct('CompanyName', 'https://github.com/freestuff'),
                StringStruct('FileDescription', 'freestuff%s' % (MACHINE and f' ({MACHINE})')),
                StringStruct('FileVersion', version),
                StringStruct('InternalName', f'freestuff{suffix}'),
                StringStruct('OriginalFilename', f'freestuff{suffix}.exe'),
                StringStruct('ProductName', f'freestuff{suffix}'),
                StringStruct(
