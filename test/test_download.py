...
import freestuff.YoutubeDL  # isort: split
from freestuff.extractor import get_info_extractor
from freestuff.networking.exceptions import HTTPError, TransportError
...
class YoutubeDL(freestuff.YoutubeDL):
...
def generator(test_case, tname):
    def test_template(self):
        ...
        ie = freestuff.extractor.get_info_extractor(test_case['name'])()
