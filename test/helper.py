...
import freestuff.extractor
from freestuff import YoutubeDL
from freestuff.utils import preferredencoding, try_call, write_string, find_available_port
...
def gettestcases(include_onlymatching=False):
    for ie in freestuff.extractor.gen_extractors():
