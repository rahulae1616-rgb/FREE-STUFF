...
from freestuff.utils._utils import (
    _UnsafeExtensionError,
    _desktop_entry_localestring,
)
from freestuff.utils.networking import (
    HTTPHeaderDict,
    escape_rfc3986,
    normalize_url,
    remove_dot_segments,
...
class TestUtil(unittest.TestCase):
    ...
    def test_expand_path(self):
        ...
        os.environ['freestuff_EXPATH_PATH'] = 'expanded'
        self.assertEqual(expand_path(env('freestuff_EXPATH_PATH')), 'expanded')
        ...
        try:
            ...
            self.assertEqual(
                expand_path('~/{}'.format(env('freestuff_EXPATH_PATH'))),
