...
from freestuff.globals import all_plugins_loaded
...
from freestuff import YoutubeDL
from freestuff.extractor.common import InfoExtractor
from freestuff.postprocessor.common import PostProcessor
from freestuff.utils import (
    ExtractorError,
    LazyList,
    OnDemandPagedList,
    int_or_none,
...
class TestFormatSelection(unittest.TestCase):
    ...
    @patch('freestuff.postprocessor.ffmpeg.FFmpegMergerPP.available', False)
    ...
    @patch('freestuff.postprocessor.ffmpeg.FFmpegMergerPP.available', True)
    @patch('freestuff.postprocessor.ffmpeg.FFmpegMergerPP.can_merge', lambda _: True)
...
class TestYoutubeDL(unittest.TestCase):
    ...
    def test_prepare_outtmpl_and_filename(self):
        ...
        os.environ['__freestuff_var'] = 'expanded'
        envvar = '%__freestuff_var%' if os.name == 'nt' else '$__freestuff_var'
