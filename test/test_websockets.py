...
from freestuff import socks
from freestuff.cookies import YoutubeDLCookieJar
from freestuff.dependencies import websockets
from freestuff.networking import Request
...
from freestuff.utils.traversal import traverse_obj
from freestuff.utils.networking import HTTPHeaderDict
...
class TestWebsocketsRequestHandler:
    ...
    def test_request_error_mapping(self, handler, monkeypatch, raised, expected):
        ...
        import freestuff.networking._websockets
        with handler() as rh:
            def fake_connect(*args, **kwargs):
                raise raised()
            monkeypatch.setattr(freestuff.networking._websockets, 'create_connection', lambda *args, **kwargs: None)
    ...
    def test_ws_send_error_mapping(self, handler, monkeypatch, raised, expected, match):
        from freestuff.networking._websockets import WebsocketsResponseAdapter
