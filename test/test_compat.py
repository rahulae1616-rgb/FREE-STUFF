...
from freestuff import compat
from freestuff.compat import urllib  # isort: split
from freestuff.compat import compat_etree_fromstring, compat_expanduser, compat_datetime_from_timestamp
from freestuff.compat.urllib.request import getproxies
