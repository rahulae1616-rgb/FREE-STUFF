...
from freestuff.networking.common import Features, DEFAULT_TIMEOUT
...
from freestuff.cookies import YoutubeDLCookieJar
from freestuff.dependencies import brotli, curl_cffi, requests, urllib3
from freestuff.networking import (
    HEADRequest,
    PATCHRequest,
    PUTRequest,
    Request,
...
from freestuff.networking._urllib import UrllibRH
from freestuff.networking.exceptions import (
...
from freestuff.networking.impersonate import (
    ImpersonateRequestHandler,
    ImpersonateTarget,
)
from freestuff.utils import YoutubeDLError
from freestuff.utils._utils import _YDLLogger as FakeLogger
from freestuff.utils.networking import HTTPHeaderDict, std_headers
...
class TestRequestsRequestHandler(TestRequestHandlerBase):
    ...
    def test_response_error_mapping(self, handler, monkeypatch, raised, expected, match):
        ...
        from freestuff.networking._requests import RequestsResponseAdapter
...
class TestCurlCFFIRequestHandler(TestRequestHandlerBase):
    ...
    def test_response_error_mapping(self, handler, monkeypatch, raised, expected, match):
        ...
        from freestuff.networking._curlcffi import CurlCFFIResponseAdapter
    ...
    def test_response_reader(self, handler):
        ...
        from freestuff.networking._curlcffi import CurlCFFIResponseReader
