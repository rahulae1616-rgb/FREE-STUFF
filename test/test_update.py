...
from freestuff.update import UpdateInfo, Updater, UPDATE_SOURCES, _make_label


# XXX: Keep in sync with freestuff.update.UPDATE_SOURCES
TEST_UPDATE_SOURCES = {
    'stable': 'freestuff/freestuff',
    'nightly': 'freestuff/freestuff-nightly-builds',
    'master': 'freestuff/freestuff-master-builds',
}

TEST_API_DATA = {
    'freestuff/freestuff/latest': {
        'tag_name': '2023.12.31',
        'target_commitish': 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb',
        'name': 'freestuff 2023.12.31',
        'body': 'BODY',
    },
    'freestuff/freestuff-nightly-builds/latest': {
        'tag_name': '2023.12.31.123456',
        'target_commitish': 'master',
        'name': 'freestuff nightly 2023.12.31.123456',
        'body': 'Generated from: https://github.com/freestuff/freestuff/commit/cccccccccccccccccccccccccccccccccccccccc',
    },
    'freestuff/freestuff-master-builds/latest': {
        'tag_name': '2023.12.31.987654',
        'target_commitish': 'master',
        'name': 'freestuff master 2023.12.31.987654',
        'body': 'Generated from: https://github.com/freestuff/freestuff/commit/dddddddddddddddddddddddddddddddddddddddd',
    },
    'freestuff/freestuff/tags/testing': {
        'tag_name': 'testing',
        'target_commitish': '9999999999999999999999999999999999999999',
        'name': 'testing',
        'body': 'BODY',
    },
    'fork/freestuff/latest': {
        'tag_name': '2050.12.31',
        'target_commitish': 'eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
        'name': '2050.12.31',
        'body': 'BODY',
    },
    'fork/freestuff/tags/pr0000': {
        'tag_name': 'pr0000',
        'target_commitish': 'ffffffffffffffffffffffffffffffffffffffff',
        'name': 'pr1234 2023.11.11.000000',
        'body': 'BODY',
    },
    'fork/freestuff/tags/pr1234': {
        'tag_name': 'pr1234',
        'target_commitish': '0000000000000000000000000000000000000000',
        'name': 'pr1234 2023.12.31.555555',
        'body': 'BODY',
    },
    'fork/freestuff/tags/pr9999': {
        'tag_name': 'pr9999',
        'target_commitish': '1111111111111111111111111111111111111111',
        'name': 'pr9999',
        'body': 'BODY',
    },
    'fork/freestuff-satellite/tags/pr987': {
        'tag_name': 'pr987',
        'target_commitish': 'master',
        'name': 'pr987',
        'body': 'Generated from: https://github.com/freestuff/freestuff/commit/2222222222222222222222222222222222222222',
    },
}
...
lockV2 freestuff/freestuff 2022.08.18.36 .+ Python 3\.6
lockV2 freestuff/freestuff 2023.11.16 (?!win_x86_exe).+ Python 3\.7
lockV2 freestuff/freestuff 2023.11.16 win_x86_exe .+ Windows-(?:Vista|2008Server)
lockV2 freestuff/freestuff 2024.10.22 py2exe .+
lockV2 freestuff/freestuff 2024.10.22 linux_(?:armv7l|aarch64)_exe .+-glibc2\.(?:[12]?\d|30)\b
lockV2 freestuff/freestuff 2024.10.22 zip Python 3\.8
lockV2 freestuff/freestuff 2024.10.22 win(?:_x86)?_exe Python 3\.[78].+ Windows-(?:7-|2008ServerR2)
lockV2 freestuff/freestuff 2025.08.11 darwin_legacy_exe .+
lockV2 freestuff/freestuff-nightly-builds 2023.11.15.232826 (?!win_x86_exe).+ Python 3\.7
lockV2 freestuff/freestuff-nightly-builds 2023.11.15.232826 win_x86_exe .+ Windows-(?:Vista|2008Server)
lockV2 freestuff/freestuff-nightly-builds 2024.10.22.051025 py2exe .+
lockV2 freestuff/freestuff-nightly-builds 2024.10.22.051025 linux_(?:armv7l|aarch64)_exe .+-glibc2\.(?:[12]?\d|30)\b
lockV2 freestuff/freestuff-nightly-builds 2024.10.22.051025 zip Python 3\.8
lockV2 freestuff/freestuff-nightly-builds 2024.10.22.051025 win(?:_x86)?_exe Python 3\.[78].+ Windows-(?:7-|2008ServerR2)
lockV2 freestuff/freestuff-nightly-builds 2025.08.12.233030 darwin_legacy_exe .+
lockV2 freestuff/freestuff-master-builds 2023.11.15.232812 (?!win_x86_exe).+ Python 3\.7
lockV2 freestuff/freestuff-master-builds 2023.11.15.232812 win_x86_exe .+ Windows-(?:Vista|2008Server)
lockV2 freestuff/freestuff-master-builds 2024.10.22.045052 py2exe .+
lockV2 freestuff/freestuff-master-builds 2024.10.22.060347 linux_(?:armv7l|aarch64)_exe .+-glibc2\.(?:[12]?\d|30)\b
lockV2 freestuff/freestuff-master-builds 2024.10.22.060347 zip Python 3\.8
lockV2 freestuff/freestuff-master-builds 2024.10.22.060347 win(?:_x86)?_exe Python 3\.[78].+ Windows-(?:7-|2008ServerR2)
lockV2 freestuff/freestuff-master-builds 2025.08.12.232447 darwin_legacy_exe .+
'''
...
lockV2 fork/freestuff pr0000 .+ Python 3.6
lockV2 fork/freestuff pr1234 (?!win_x86_exe).+ Python 3\.7
lockV2 fork/freestuff pr1234 win_x86_exe .+ Windows-(?:Vista|2008Server)
lockV2 fork/freestuff pr9999 .+ Python 3.11
'''
...
class TestUpdate(unittest.TestCase):
    ...
    def test_update_spec(self):
        ...
        def test(lockfile, identifier, input_tag, expect_tag, exact=False, repo='freestuff/freestuff'):
        ...
        test(TEST_LOCKFILE_FORK, 'zip Python 3.6.3', 'pr0000', None, repo='fork/freestuff')
        test(TEST_LOCKFILE_FORK, 'zip Python 3.7.4', 'pr0000', 'pr0000', repo='fork/freestuff')
        test(TEST_LOCKFILE_FORK, 'zip Python 3.7.4', 'pr1234', None, repo='fork/freestuff')
        test(TEST_LOCKFILE_FORK, 'zip Python 3.8.1', 'pr1234', 'pr1234', repo='fork/freestuff', exact=True)
        test(
            TEST_LOCKFILE_FORK, 'win_x86_exe Python 3.7.9 (CPython x86 32bit) - Windows-Vista-6.0.6003-SP2',
            'pr1234', None, repo='fork/freestuff')
        test(
            TEST_LOCKFILE_FORK, 'win_x86_exe Python 3.7.9 (CPython x86 32bit) - Windows-7-6.1.7601-SP1',
            '2023.12.31', '2023.12.31', repo='fork/freestuff')
        test(TEST_LOCKFILE_FORK, 'zip Python 3.11.2', 'pr9999', None, repo='fork/freestuff', exact=True)
        test(TEST_LOCKFILE_FORK, 'zip Python 3.12.0', 'pr9999', 'pr9999', repo='fork/freestuff')
    ...
    def test_make_label(self):
        ...
        for inputs, expected in [
            ...
            (['fork/freestuff', 'experimental', '2025.12.31.000000'], 'fork/freestuff@experimental build 2025.12.31.000000'),
            (['fork/freestuff', '2025.09.02', '2025.09.02'], 'fork/freestuff@2025.09.02'),
            ...
            (['fork/freestuff', 'experimental'], 'fork/freestuff@experimental'),
        ]:
