...
PACKAGE_NAME = 'freestuff_plugins'
COMPAT_PACKAGE_NAME = 'freestuff_plugins'
...
def default_plugin_paths():
    ...
    # Load from freestuff config folders
    yield from _get_package_paths(
        *get_user_config_dirs('freestuff'),
        *get_system_config_dirs('freestuff'),
        containing_folder='plugins',
    )

    # Load from freestuff-plugins folders
    yield from _get_package_paths(
        get_executable_path(),
        *get_user_config_dirs(''),
        *get_system_config_dirs(''),
        containing_folder='freestuff-plugins',
    )
...
class PluginFinder(importlib.abc.MetaPathFinder):
    ...
    It searches in sys.path and freestuff config folders for
...
def load_plugins(plugin_spec: PluginSpec):
    ...
    # nor are considered part of the freestuff_plugins namespace package
