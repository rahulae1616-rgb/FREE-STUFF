...
class GenericIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        # https://github.com/freestuff/freestuff/pull/6775
        ...
        # https://github.com/freestuff/freestuff/commit/3e01ce744a981d8f19ae77ec695005e7000f4703
        ...
        # https://github.com/freestuff/freestuff/pull/12256
        ...
        # https://github.com/freestuff/freestuff/commit/80e8493ee7c3083f4e215794e4a67ba5265f24f7
        ...
        # https://github.com/freestuff/freestuff/issues/1476
        ...
        # https://github.com/freestuff/freestuff/commit/a318f59d14792d25b2206c3f50181e03e8716db7
        ...
        # https://github.com/freestuff/freestuff/commit/f3c0c77304bc0e5614a65c45629de22f067685ac
        ...
        # https://github.com/freestuff/freestuff/pull/5145
    ...
    def _real_extract(self, url):
                    ...
                    if default_search == 'auto_warning':
                        if re.match(r'^(?:url|URL)$', url):
                            raise ExtractorError(
                                f'Invalid URL:  {url!r} . Call freestuff like this:  freestuff -v "https://www.youtube.com/watch?v=YE7VzlLtp-4"  ',
                                expected=True)
                        else:
                            self.report_warning(
        ...
        # Do not impersonate by default; see https://github.com/freestuff/freestuff/issues/11335
        ...
        # test whether it's HTML or not). According to freestuff default Accept-Encoding
        ...
        try:
            ...
            if not self._downloader._impersonate_target_available(ImpersonateTarget()):
                msg += ('see  https://github.com/freestuff/freestuff#impersonation  for '
        ...
        try:
            ...
            if doc.tag == 'rss':
                ...
                info_dict['formats'], info_dict['subtitles'] = self._parse_mpd_formats_and_subtitles(
                    doc,
                    # Do not use freestuff.utils.base_url here since it will raise on file:// URLs
    ...
    def _extract_embeds(self, url, webpage, *, urlh=None, info_dict={}):
        ...
        if not found:
            ...
            # be supported by freestuff thus this is checked the very last (see
            # https://dev.twitter.com/cards/types/player#On_twitter.com_via_desktop_browser)
