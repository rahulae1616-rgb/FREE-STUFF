...
from freestuff.extractor.youtube.jsc._builtin.ejs import (
    _EJS_WIKI_URL,
    EJSBaseJCP,
    Script,
    ScriptSource,
...
from freestuff.extractor.youtube.jsc._builtin.vendor import load_script
...
from freestuff.extractor.youtube.pot._provider import BuiltinIEContentProvider
from freestuff.extractor.youtube.pot.provider import provider_bug_report_message
from freestuff.utils import Popen
from freestuff.utils.networking import HTTPHeaderDict, clean_proxies
...
class BunJCP(EJSBaseJCP, BuiltinIEContentProvider):
    ...
    _BUN_DEPRECATION_URL = 'https://github.com/freestuff/freestuff/issues/16766'
