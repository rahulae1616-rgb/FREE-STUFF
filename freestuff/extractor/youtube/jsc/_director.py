...
from freestuff.extractor.youtube.jsc._builtin.ejs import _EJS_WIKI_URL
from freestuff.extractor.youtube.jsc._registry import (
    _jsc_preferences,
    _jsc_providers,
)
...
from freestuff.extractor.youtube.pot._director import YoutubeIEContentProviderLogger, provider_display_list
from freestuff.extractor.youtube.pot._provider import (
    IEContentProviderLogger,
)
from freestuff.extractor.youtube.pot.provider import (
...
if typing.TYPE_CHECKING:
    ...
    from freestuff.extractor.youtube.jsc._builtin.ejs import _SkippedComponent
    from freestuff.extractor.youtube.jsc.provider import Preference as JsChallengePreference
