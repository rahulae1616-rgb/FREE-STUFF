...
from freestuff.extractor.youtube.pot._registry import _pot_providers, _ptp_preferences
from freestuff.networking import Request, Response
from freestuff.utils import traverse_obj
...
class PoTokenProvider(IEContentProvider, abc.ABC, suffix='PTP'):
    ...
    # For a list of WebPO client names, see freestuff.extractor.youtube.pot.utils.WEBPO_CLIENTS.
    # Also see freestuff.extractor.youtube._base.INNERTUBE_CLIENTS
