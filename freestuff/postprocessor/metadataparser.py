...
class MetadataFromTitlePP(MetadataParserPP):
    def __init__(self, downloader, titleformat):
        ...
        self.deprecation_warning(
            'freestuff.postprocessor.MetadataFromTitlePP is deprecated '
            'and may be removed in a future version. Use freestuff.postprocessor.MetadataFromFieldPP instead')
