...
class PostProcessor(metaclass=PostProcessorMetaClass):
    ...
    def report_error(self, text, *args, **kwargs):
        self.deprecation_warning('"freestuff.postprocessor.PostProcessor.report_error" is deprecated. '
                                 'raise "freestuff.utils.PostProcessingError" instead')
        if self._downloader:
    ...
    def report_progress(self, s):
        ...
        self._downloader.to_console_title(self._downloader.evaluate_outtmpl(
            progress_template.get('postprocess-title') or 'FREE STUFF %(progress._default_template)s',
