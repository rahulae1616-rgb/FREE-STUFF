...
def validate_options(opts):
    ...
    if opts.format == 'best':
        warnings.append('.\n         '.join((
            ...
            'To let FREE STUFF download and merge the best available formats, simply do not pass any format selection',
    ...
    if hasattr(opts, '_deprecated_options'):
        deprecation_warnings.append(
            ...
            'See  https://github.com/rahulae1616-rgb/FREE-STUFF/issues/14198  for more details')
            ...
            if not args and os.name == 'nt' and getattr(sys, 'frozen', False):
                ...
                if attached_processes == 1 or (is_onefile and attached_processes == 2):
                    print(parser._generate_error_message(
                        ...
                        'Please read the README for further information on how to use FREE STUFF: '
