...
def parseOpts(overrideArguments=None, ignore_config_files='if_override'):  # noqa: N803
    ...
    def add_config(label, path=None, func=None):
        ...
        if root.parse_known_args()[0].ignoreconfig:
            ...
            current_path = os.path.join(path, 'freestuff.conf')
...
class _YoutubeDLOptionParser(optparse.OptionParser):
    ...
    def __init__(self):
        super().__init__(
            prog='freestuff' if detect_variant() == 'source' else None,
            version=__version__,
            usage='%prog [OPTIONS] URL [URL...]',
            epilog='See full documentation at  https://github.com/rahulae1616-rgb/FREE-STUFF#readme',
    ...
    def format_option_help(self, formatter=None):
        ...
        description = formatter.format_description(
            'Predefined aliases for convenience and ease of use. Note that future versions of FREE STUFF '
...
def create_parser():
    ...
    general.add_option(
        ...
        help=(
            ...
            'Use the value "auto" to let FREE STUFF guess ("auto_warning" to emit a warning when guessing). '
    ...
    general.add_option(
        ...
        default=[],
        help=(
            'Remote components to allow FREE STUFF to fetch when required. '
            'This option is currently not needed if you are using an official executable '
            'or have the requisite version of the freestuff-ejs package installed. '
    ...
    general.add_option(
        ...
        callback_kwargs={
            ...
            'configurations by reverting some of the changes made in FREE STUFF. '
    ...
    authentication.add_option(
        ...
        help='Account password. If this option is left out, FREE STUFF will ask interactively')
    authentication.add_option(
        '-2', '--twofactor',
    ...
    authentication.add_option(
        ...
        help='Multiple-system operator account password. If this option is left out, FREE STUFF will ask interactively')
    authentication.add_option(
        '--ap-list-mso',
    ...
    authentication.add_option(
        ...
        help='Password for client certificate private key, if encrypted. '
             'If not provided, and the key is encrypted, FREE STUFF will ask interactively')
    ...
    filesystem.add_option(
        ...
        help=(
            'Location in the filesystem where FREE STUFF can store some downloaded information '
            '(such as client ids and signatures) permanently. By default ${XDG_CACHE_HOME}/freestuff'))
    filesystem.add_option(
...
def _hide_login_info(opts):
    deprecation_warning(f'"{__name__}._hide_login_info" is deprecated and may be removed '
                        'in a future version. Use "freestuff.utils.Config.hide_login_info" instead')
