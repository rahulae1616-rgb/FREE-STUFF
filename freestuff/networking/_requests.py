...
if urllib3_version < (2, 0, 2):
    urllib3._freestuff__version = f'{urllib3.__version__} (unsupported)'
    raise ImportError('Only urllib3 >= 2.0.2 is supported')

if requests.__build__ < 0x023202:
    requests._freestuff__version = f'{requests.__version__} (unsupported)'
...
class RequestsSession(requests.sessions.Session):
    ...
    def rebuild_method(self, prepared_request, response):
        ...
        # See: https://github.com/freestuff/freestuff/issues/9020
...
class RequestsRH(RequestHandler, InstanceStoreMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.verbose:
            ...
            # It could technically be problematic for scripts embedding freestuff.
    ...
    def close(self):
        ...
        # See: https://github.com/freestuff/freestuff/issues/8922
