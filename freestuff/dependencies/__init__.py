...
An attribute "_freestuff__identifier" may be inserted into the module if it uses an ambiguous namespace"""
...
try:
    ...
    sqlite3._freestuff__version = sqlite3.sqlite_version
except ImportError:
...
try:
    ...
    if hasattr(xattr, 'set'):  # pyxattr
        xattr._freestuff__identifier = 'pyxattr'
